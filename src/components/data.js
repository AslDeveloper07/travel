...
import { Card1, Card2, Card3, Card4, Card5, Card6, User1, User2, User3 } from "../assets/assets";
...
export const testamonialData = [
  ...
  {
    yulduzchalar: <FaStar />,
    about:"The trip to Bali was absolutely perfect. Every detail was taken care of, and the local guides were exceptional. ",
    usrImage: User1,
  ...
  {
    yulduzchalar: <FaStar />,
    about:"Our family vacation to Greece exceeded all expectations. The accommodations were luxurious and the itinerary was perfectly balanced.",
    usrImage: User2,
  ...
  {
    yulduzchalar: <FaStar />,
    about:"I've traveled with many agencies before, but TravelWorld provides a level of service that's truly unmatched. Highly recommended!",
    usrImage: User3,
